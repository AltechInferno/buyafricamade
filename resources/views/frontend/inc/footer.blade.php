...
<section class="py-3 text-light footer-widget border-bottom" style="border-color: #3d3d46 !important; background-color: #0A5516!important;">
    <div class="container">
        <!-- footer logo -->
        <div class="mt-3 mb-4">
...
@endphp
<section class="py-lg-3 text-light footer-widget" style="background-color: #0A5516 !important;">
    ...
    <div class="d-lg-none bg-transparent">
        ...
        <div class="aiz-accordion-wrap bg-black">
            ...
            <div class="aiz-accordion-panel bg-transparent" style="background-color: #CAF42E !important;">
                <div class="container">
        ...
        <div class="aiz-accordion-wrap bg-black">
            ...
            <div class="aiz-accordion-panel bg-transparent" style="background-color: #0A5516 !important;">
                <div class="container">
                    <ul class="list-unstyled mt-3">
                        <li class="mb-2">
                            <p  class="fs-13 text-secondary mb-1">{{ translate('Address') }}</p>
...
<!-- FOOTER -->
<footer class="pt-3 pb-7 pb-xl-3 bg-black text-soft-light" style="background-color: #0A5516 !important;">
    <div class="container">
