        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <select class="form-control mb-3 aiz-selectpicker rounded-0" name="state_id" id="edit_state"  data-live-search="true" required>
                        <option value="{{ $address_data->StateName }}" @if($address_data->stateName) selected @endif>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <select class="form-control mb-3 aiz-selectpicker rounded-0" data-live-search="true" name="city_id" required>
                        ...
                        <option value="{{ $address_data->cityName }}" @if($address_data->cityName) selected @endif>
                            {{ $address_data->cityName }}
                        </option>
