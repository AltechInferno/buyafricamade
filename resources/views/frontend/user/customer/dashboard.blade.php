                ...
                @if(Auth::user()->addresses != null)
                    ...
                    @if($address != null)
                        <ul class="list-unstyled mb-5">
                            ...
                            <li class="fs-14 fw-400 text-derk pb-1"><span>{{ $address->postal_code }} - {{ $address->cityName }},</span></li>
                            <li class="fs-14 fw-400 text-derk pb-1"><span>{{ $address->stateName }},</span></li>
