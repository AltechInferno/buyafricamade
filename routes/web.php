...
Route::get('/check-route', function () {
    ...
    // Return the output as plain text for debugging
...
Route::group(['middleware' => ['auth']], function () {
    ...
    //Address
    Route::post('/calculate-delivery-fee', [AddressController::class, 'handleDeliveryTypeSelection'])->name('calculate-delivery-fee');
    Route::get('/get-states/{country_id}', [AddressController::class, 'getCSStates'])->name('get-states');
    Route::get('/get-cities-by-state/{state}', [AddressController::class, 'getCSCitiesByState'])->name('get-cities-by-state');
    Route::get('/get-delivery-towns/{cityCode}', [AddressController::class, 'getDeliveryTown'])->name('get-delivery-towns');
    Route::resource('addresses', AddressController::class);
    Route::controller(AddressController::class)->group(function () {
        // Route::posts('/get-states', 'getStates')->name('get-state');
        // Route::post('/get-cities', 'getCities')->name('get-city');
