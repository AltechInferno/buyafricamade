...
Route::group(['namespace' => 'App\Http\Controllers\Seller', 'prefix' => 'seller', 'middleware' => ['seller', 'verified', 'user', 'prevent-back-history'], 'as' => 'seller.'], function () {
    ...
    Route::controller(AddressController::class)->group(function () {
        Route::get('/get-states/{country_id}','getCSStates')->name('get-states');
        Route::get('/get-cities-by-state/{state}','getCSCitiesByState')->name('get-cities-by-state');
        Route::get('/get-delivery-towns/{cityCode}','getDeliveryTown')->name('get-delivery-towns');
