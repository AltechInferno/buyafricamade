...
class _ProductDetailsState extends State<ProductDetails> {
            ...
            child: _productDetails != null
                ...
                : Padding(
                    padding: EdgeInsets.symmetric(
                        vertical: 63.0.h, horizontal: defaultPadding.w),
                    child: SingleChildScrollView(
                      child: Column(
                        children: [
                          ShimmerHelper().buildBasicShimmer(
                              height: 363.h, width: double.infinity),
  ...
  buildProductImageSection() {
    ...
    GestureDetector getIndicator(int imageIndex) {
      return GestureDetector(
        onTap: () {
          setState(() {
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
              ...
              color: (currentImageIndex == imageIndex
                  ? primaryColor
                  : Colors.grey)),
        ),
      );
    ...
    if (_productImageList.length == 0) {
      return ShimmerHelper().buildBasicShimmer(height: 40.0, width: 40.0);
    }
    return Stack(
      children: [
        Column(
          children: [
            Container(
              ...
              child: FadeInImage.assetNetwork(
                placeholder: 'assets/placeholder.png',
                image: _productImageList[currentImageIndex],
                fit: BoxFit.fill,
                height: 413.h,
                width: MediaQuery.of(context).size.width,
              ),
        ...
        if (_productImageList.length > 0)
          Positioned(
            ...
            children: List.generate(
                _productImageList.length, (index) => getIndicator(index)),
          ))
      ],
    );
  }
