...
import 'package:active_ecommerce_flutter/screens/on_boarding/on_boarding_start.dart';
...
class _SplashState extends State<Splash> {
  ...
  void initState() {
    ...
    SharedPreferences.getInstance().then((prefValue)  {
      print( prefValue.getBool("isDoneOnBoarding"));
      setState(() {
        isDoneOnBoarding = prefValue.getBool("isDoneOnBoarding") != null;
      });
    });
    super.initState();
    _initPackageInfo();
  ...
  Widget build(BuildContext context) {
    ...
    return CustomSplashScreen(
      ...
      navigateAfterSeconds: isDoneOnBoarding ? Main() : OnBoardingStart() ,
          ...
          child: Stack(
            children: [
              ...
              Column(
                ...
                children: [
                  SizedBox(height: MediaQuery.of(context).size.height * 345/896,),
                  Center(child: Image.asset("assets/bam_logo_large.png", width:MediaQuery.of(context).size.width * 259/414, height:MediaQuery.of(context).size.height * 87/896 ,fit: BoxFit.fill,)),
                ],
              ),
              Align(
                child: Image.asset("assets/black Friday-cuate(1)1.png", width: double.maxFinite, height: MediaQuery.of(context).size.height * 254/896,),
